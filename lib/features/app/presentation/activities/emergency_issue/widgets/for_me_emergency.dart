...
class ForMeEmergency extends StatelessWidget {
  const ForMeEmergency({super.key, required this.loaderStatus});

  final Function loaderStatus;

  @override
  Widget build(BuildContext context) {
    final bloc = context.read<EmergencyIssueBlocOwn>();
    final size = MediaQuery.of(context).size;
    final scroll = ScrollController();

    return BlocBuilder<EmergencyIssueBlocOwn, EmergencyIssueStateOwn>(
