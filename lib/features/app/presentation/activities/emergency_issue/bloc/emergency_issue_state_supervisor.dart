...
class EmergencyIssueStateSupervisor extends Equatable {
  const EmergencyIssueStateSupervisor(
      {this.date = '',
  ...
  EmergencyIssueStateSupervisor copyWith(
      {String? date,
    ...
    return EmergencyIssueStateSupervisor(
        date: date ?? this.date,
...
class EmergencyIssueInitial extends EmergencyIssueStateSupervisor {}
