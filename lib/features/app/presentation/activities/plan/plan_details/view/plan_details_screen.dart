...
import 'package:work_diary/features/app/presentation/activities/plan/plan_details/bloc/bloc.dart';
import 'package:work_diary/features/app/presentation/activities/plan/plan_details/widget/emergency_visit_cart.dart';

class PlanDetailsScreen extends StatelessWidget {
  const PlanDetailsScreen({Key? key, required this.visitData})
      : super(key: key);
...
class PlanDetailsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bloc = context.read<PlanDetailsBloc>();
                      ...
                      child: ButtonB(
                        press: () {
                          bloc.add(GetComments(
                              ...
                              status: state
                                  .visitDetails.visitData!.btns![index]!.value!,
                              isCancel: state.visitDetails.visitData!
                                      .btns![index]!.name ==
                                  "Cancel"));
                        },
                        ...
                        shadow: false,
                        loading:
                            state.visitDetails.visitData!.btns![index]!.name ==
                                    "Cancel"
                                ? state.cancelLoading
                                : state.startLoading,
                      ),
            ...
            ? ListView(
                ...
                children: [
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              // TextB(
                              //   text:
                              //       state.visitDetails.visitData!.isUpcoming !=
                              //                   null &&
                              //               state.visitDetails.visitData!
                              //                   .isUpcoming!
                              //           ? "Upcoming"
                              //           : state.time,
                              ...
                              TextB(
                                text:
                                    'Plan Date: ${state.visitDetails.visitData!.dateFor!}',
                  ...
                  VisitInfo(
                    ...
                    title: "Plan Status",
                    info: state.visitDetails.visitData!.status!,
                    infoColor: bDarkBlue,
                  ),
                  const SizedBox(height: 20),
                  VisitInfo(
                      ...
                      state.visitDetails.visitData!.supervisor != null
                          ? Flexible(
                              child: VisitInfo(
                                ...
                                infoColor: bGreen,
                                title: state.visitDetails.visitData!.status ==
                                        "Approved"
                                    ? "Approved by"
                                    : "Supervisor",
