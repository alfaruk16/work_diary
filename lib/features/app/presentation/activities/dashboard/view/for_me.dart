...
class ForMeView extends StatelessWidget {
  const ForMeView({super.key});
      ...
      builder: (context, state) {
        return Container(
          ...
          child: RefreshIndicator(
            onRefresh: () async {
              bloc.add(const GetChart(selectedTab: 0));
              bloc.add(const GetDashboardData(selectedTab: 0));
            },
            child: ListView(
              padding: EdgeInsets.zero,
              children: [
                if (state.dashboard.data != null)
                  Column(
                    children: [
                      Container(
                        ...
                        child: state.chartData.charts != null
                            ? BarChartB(
                      ...
                      if (state.dashboard.data != null &&
                          state.dashboard.data!.onGoing != null)
                        Column(
                          children: [
                            ...
                            OnGoingVisitCard(
                              ...
                              onGoingVisit: state.dashboard.data!.onGoing!,
                            ),
                          ],
                        ),
                      const SizedBox(height: 20),
                      if (state.dashboard.data!.waitingForApproval != 0)
                        InkWell(
                          onTap: () {
                            bloc.add(
                      ...
                      if (state.dashboard.data != null && state.hasAreaPlan)
                        Plan(dashboardResponse: state.dashboard),
                      if (state.dashboard.data!.waitingForApproval != 0)
                        const SizedBox(height: 20),
                      Row(
                        children: [
                          StatusCard(
                            ...
                            total: state.dashboard.data!.todaysVisit!.total!,
                            completed:
                                state.dashboard.data!.todaysVisit!.completed!,
                          ),
                          ...
                          StatusCard(
                            ...
                            total: state.dashboard.data!.upcomingVisit!,
                          ),
                        ],
                      ),
