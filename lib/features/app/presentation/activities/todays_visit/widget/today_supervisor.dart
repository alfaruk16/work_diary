...
class TodaySupervisor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bloc = context.read<TodaysVisitBlocSupervisor>();
    final size = MediaQuery.of(context).size;
    final scroll = ScrollController();

    return BlocBuilder<TodaysVisitBlocSupervisor, TodaysVisitStateSuperVisor>(
                  ...
                  Column(
                    children: [
                      ...
                      OnGoingVisitCard(
                        ...
                        goToOngoingScreen: (String type, VisitData visitData) {
                          bloc.add(
                            GoToPlanList(planType: type, visitData: visitData),
                          );
                        },
                      ),
