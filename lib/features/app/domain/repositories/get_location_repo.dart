  ...
  Future<String?> getAddress({required double lat, required double lng}) async {
    ...
    if (androidInfo.isPhysicalDevice) {
      try {
        ...
        address =
            "${placeMarks[0].name!}${placeMarks[0].subLocality != null && placeMarks[0].name != placeMarks[0].subLocality ? ", ${placeMarks[0].subLocality!}" : ""}${placeMarks[0].locality != null ? ", ${placeMarks[0].locality!}" : ""}";
      } on Exception {
        return "NotFound";
      }
    }
