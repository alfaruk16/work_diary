...
import 'package:work_diary/features/app/presentation/activities/plan/todays_plan/widget/today_own.dart';
import 'package:work_diary/features/app/presentation/activities/plan/todays_plan/widget/today_supervisor.dart';
...
class TodaysPlanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
          ...
          BlocProvider(
              create: (_) => TodaysPlanBlocOwn(getIt<IFlutterNavigator>(),
                ...
                ..add(SetPlanType(
                    ...
                    status: status))),
          BlocProvider(
              create: (_) => TodaysPlanBlocSupervisor(
        ...
        child: TodaysPlanView(
            selectedTab: selectedTab,
            selectedDateDropdown: selectedDateDropdown));
  }
}

class TodaysPlanView extends StatelessWidget {
  const TodaysPlanView({Key? key, this.selectedTab, this.selectedDateDropdown})
      : super(key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final bloc = context.read<TodaysPlanBloc>();
    int? tabIndex = selectedTab;

    return BlocBuilder<TodaysPlanBloc, TodaysPlanState>(
          ...
          PopupMenuItem(
            ...
            onTap: () {
              bloc.add(MenuItemScreens(
                  name: PopUpMenu.createNewPlan.name, context: context));
            },
          ),
          PopupMenuItem(
